...
config_7 = {'data_set': 'lab_data_im_nc', 'model_type': 'LSTM', 'target': 'IM', 'target_unit': '1/K0',
            'use_charge': False, 'bidirectional': True, 'num_layers': 3, 'num_lstm_units': 128, 'pad_by': 'batch'}

# -------- EXP 8 : Convolution IM Prediction on Lab Data Without Charge -----------
config_8 = {'data_set': 'lab_data_im_nc', 'model_type': 'Conv', 'target': 'IM', 'target_unit': '1/K0',
            'use_charge': False, 'kernel': 10, 'pad_by': ''}

# -------- EXP 9 : Transformer IM Prediction on Lab Data Without Charge -----------
config_9 = {'data_set': 'lab_data_im_nc', 'model_type': 'Transformer', 'target': 'IM', 'target_unit': '1/K0',
            'use_charge': False, 'num_attn_heads': 2, 'num_layers': 2, 'dim_feed_fwd': 200, 'pad_by': 'batch'}

# -------- EXP 10 : LSTM IM Prediction on Lab Data With Charge -----------
config_10 = {'data_set': 'lab_data_im_wc', 'model_type': 'LSTM', 'target': 'IM', 'target_unit': '1/K0',
             'use_charge': True, 'bidirectional': True, 'num_layers': 3, 'num_lstm_units': 128, 'pad_by': 'batch'}

# -------- EXP 11 : Convolution IM Prediction on Lab Data With Charge -----------
config_11 = {'data_set': 'lab_data_im_wc', 'model_type': 'Conv', 'target': 'IM', 'target_unit': '1/K0',
             'use_charge': True, 'kernel': 10, 'pad_by': ''}

# -------- EXP 12 : Transformer IM Prediction on Lab Data With Charge -----------
config_12 = {'data_set': 'lab_data_im_wc', 'model_type': 'Transformer', 'target': 'IM', 'target_unit': '1/K0',
             'use_charge': True, 'num_attn_heads': 2, 'num_layers': 2, 'dim_feed_fwd': 200, 'pad_by': 'batch'}

# -------- EXP 13 : LSTM IM Prediction on Deep Learning CCS Data Without Charge -----------
config_13 = {'data_set': 'deep_learning_ccs_im_nc', 'model_type': 'LSTM', 'target': 'IM', 'target_unit': 'A',
             'use_charge': False, 'bidirectional': True, 'num_layers': 3, 'num_lstm_units': 128, 'pad_by': 'batch'}

# -------- EXP 14 : Convolution IM Prediction on Deep Learning CCS Data Without Charge -----------
config_14 = {'data_set': 'deep_learning_ccs_im_nc', 'model_type': 'Conv', 'target': 'IM', 'target_unit': 'A',
             'use_charge': False, 'kernel': 10, 'pad_by': ''}

# -------- EXP 15 : Transformer IM Prediction on Deep Learning CCS Data Without Charge -----------
config_15 = {'data_set': 'deep_learning_ccs_im_nc', 'model_type': 'Transformer', 'target': 'IM', 'target_unit': 'A',
             'use_charge': False, 'num_attn_heads': 2, 'num_layers': 2, 'dim_feed_fwd': 200, 'pad_by': 'batch'}

# -------- EXP 16 : LSTM IM Prediction on Deep Learning CCS Data With Charge -----------
config_16 = {'data_set': 'deep_learning_ccs_im_wc', 'model_type': 'LSTM', 'target': 'IM', 'target_unit': 'A',
             'use_charge': True, 'bidirectional': True, 'num_layers': 3, 'num_lstm_units': 128, 'pad_by': 'batch'}

# -------- EXP 17 : Convolution IM Prediction on Deep Learning CCS Data With Charge -----------
config_17 = {'data_set': 'deep_learning_ccs_im_wc', 'model_type': 'Conv', 'target': 'IM', 'target_unit': 'A',
             'use_charge': True, 'kernel': 10, 'pad_by': ''}

# -------- EXP 18 : Transformer IM Prediction on Deep Learning CCS Data With Charge -----------
config_18 = {'data_set': 'deep_learning_ccs_im_wc', 'model_type': 'Transformer', 'target': 'IM', 'target_unit': 'A',
             'use_charge': True, 'num_attn_heads': 2, 'num_layers': 2, 'dim_feed_fwd': 200, 'pad_by': 'batch'}
...
run_configs = run_configs + [config_16, config_17]  # , config_18
